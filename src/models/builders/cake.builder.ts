...
export class CakeBuilder {
    ...
    setFilling(filling: string): CakeBuilder {
        this.filling = filling; return this
    }
    ...
    build(): Cake {
        const requiredProperties = [
            this.type, this.flavor, this.filling, this.size, this.layers,
            this.frostingType, this.frostingFlavor, this.decorationType,
            this.decorationColor, this.customMessage, this.shape,
